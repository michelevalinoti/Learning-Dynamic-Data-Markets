...
public class FullInformationPlatform extends Platform {
	...
	public FullInformationPlatform(double rate, int N, double gamma, double delta, String costDistribution, double[] costParameters) {

		super(rate, N, gamma, delta, costDistribution, costParameters);
	...
	public void setExpectedFuturePayment() {
		...
		double notDiscountedExpectedFuturePayment = transitionProbability*fullInformationPayments[databases+1]+(1-transitionProbability)*fullInformationPayments[databases];
