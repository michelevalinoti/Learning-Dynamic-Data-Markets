...
public class Payment{
	...
	public static double computeFutureTotalPaymentsAtStateK(double rate, int N, double gamma, double delta, String distribution, double[] parameters, double[] fullInformationPayments, int k) {
		
		return computeFutureTotalPaymentsUpToStateK(rate, N, gamma, delta, distribution, parameters, fullInformationPayments, k)[k];
	}
